<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ATRCBookings.aspx.cs" Inherits="JustStayAdmin.ATRCBookings" %>
                                    ...
                                    <div class="sparkline13-graph">
                                        <div class="datatable-dashv1-list custom-datatable-overright">
                                            ...
                                            <asp:GridView ID="grdBookings" runat="server" AutoGenerateColumns="false" class="table table-striped" CssClass="gvv"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="ATRCName" HeaderText="ATRCName" />
                                                    <asp:BoundField DataField="ATRCNumber" HeaderText="ATRCNumber" />
