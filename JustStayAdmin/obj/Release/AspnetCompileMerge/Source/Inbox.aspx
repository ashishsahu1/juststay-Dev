<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Inbox.aspx.cs" Inherits="JustStayAdmin.Inbox" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <script type="text/javascript">
        function ShowMail(mailId) {
            ...
            if (isFromInbox == '1')
                window.location.href = "ViewMail.aspx?Id=" + mailId;
            else
