<%@ Page Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="allatrcbillreport.aspx.cs" Inherits="JustStayAdmin.Admin.allatrcbillreport" %>
    ...
    <div class="sb2-2">
        <div class="sb2-2-2">
            <ul>
                ...
                <li class="active-bre"><a href="allatrcbillreport.aspx">All ATRC Bills Report</a>
                </li>
            </ul>
        </div>
        <div class="sb2-2-3">
                ...
                <div class="col-md-12">
                    <div class="box-inn-sp">
                        ...
                        <div class="tab-inn">
                            ...
                            <asp:GridView ID="grdatrcbills" runat="server" AutoGenerateColumns="false" ShowFooter="true" Width="100%" ShowHeaderWhenEmpty="True" EmptyDataText="No records Found"
                                PageSize="100" AllowPaging="true" CssClass="table-hover" CellSpacing="0" OnPageIndexChanging="grdatrcbills_PageIndexChanging" OnRowDataBound="grdatrcbills_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Bills From-To">
                                        <ItemTemplate>
                                            <%# "BillFrom: " + Eval("BillFrom","{0:d}") + " BillTo: " + Eval("BillTo","{0:d}") %>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Paid Amt(Rs.)">
                                        <ItemTemplate>
                                            <asp:Label ID="lblpaidAmount" runat="server" Text='<%#Eval("PaidAmount")%>'>
                                            </asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <div style="padding: 0 0 5px 0; color: black;">
                                    ...
                                    <asp:BoundField HeaderText="IsPaid?" DataField="IsPaid" />
                                    <asp:BoundField HeaderText="Payment Type" DataField="PaymentBy" />
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
