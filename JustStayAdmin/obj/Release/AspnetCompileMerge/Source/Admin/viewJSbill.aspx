<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Site1.Master" CodeBehind="viewJSbill.aspx.cs" Inherits="JustStayAdmin.Admin.viewJSbill" %>
    ...
    <div class="sb2-2">
        <div class="sb2-2-2">
            <ul>
                ...
                <li class="active-bre"><a href="jsbilllist.aspx">Bills from ATRC List</a>
                </li>
            </ul>
        </div>
            ...
            <div class="table table-responsive" id="gid">
                <div class="col-md-12">
                    <div class="box-inn-sp">
                        <div class="inn-title">
                            <div class="row">
                                <table width="100%" border="0">
                                    <tr>
                                        <td style="float: left;">
                                            <h3><%= stratrcname %> (<%=stratrcnumber %>)</h3>
                                            <p><%=strownername %></p>
                                            <p><%=strownername %></p>
                                            <p><%=stratrcaddress %></p>
                        ...
                        <div class="tab-inn">
                            <asp:GridView ID="grdjsBill" runat="server" AutoGenerateColumns="false" Width="100%" ShowHeaderWhenEmpty="True" EmptyDataText="No records Found"
                                PageSize="100" AllowPaging="true" ShowFooter="true"
                                CssClass="table table-hover table-striped table-bordered"
                                CellSpacing="0" OnRowDataBound="grdJSPayatrcBill_RowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="JS Commisssion (Rs.)">
                                        <ItemTemplate>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p>
                                                    <b>For <%= stratrcname %> (<%=stratrcnumber %>),</b><br />
                                                    <br />
                                                    <br />
