<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ManageRoomLabel.aspx.cs" Inherits="JustStayAdmin.ManageRoomLabel" %>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="rfvImage" runat="server" Display="Dynamic" SetFocusOnError="true" ForeColor="Red"
                                                            ControlToValidate="rlImageUpload" ValidationGroup="valroomlabel" ErrorMessage="Icon Required!">
                                                        </asp:RequiredFieldValidator>
                                                        <br />
                                                        ...
                                                        <div class="col-lg-9">
                                                            <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                <asp:LinkButton ID="btnSave" runat="server" OnClick="btnSave_Click" CausesValidation="true" OnClientClick="return ValidateRoomLabel();"
                                                                    ValidationGroup="valroomlabel" CssClass="btn btn-sm btn-primary login-submit-cs" Text="Save"></asp:LinkButton>
                                                                <asp:LinkButton ID="lnkClose" runat="server" class="btn btn-white" PostBackUrl="~/ListRoomLabels.aspx">Cancel</asp:LinkButton>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
