<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Site1.Master" CodeBehind="allcustomerreport.aspx.cs" Inherits="JustStayAdmin.Admin.allcustomerreport" %>

<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ID="cphcustomerreport">
    ...
    <div class="sb2-2">
        <div class="sb2-2-2">
            <ul>
                ...
                <li class="active-bre"><a href="allcustomerreport.aspx">All Customer Report</a>
                </li>
            </ul>
        </div>
        <div class="sb2-2-3">
                ...
                <div class="col-md-12">
                    <div class="box-inn-sp">
                        ...
                        <div class="tab-inn">
                            ...
                            <asp:GridView ID="grdcustomer" runat="server" AutoGenerateColumns="false" ShowFooter="true" Width="100%" ShowHeaderWhenEmpty="True" EmptyDataText="No records Found"
                                PageSize="100" AllowPaging="true" CssClass="table-hover" CellSpacing="0" OnPageIndexChanging="grdcustomer_PageIndexChanging">
