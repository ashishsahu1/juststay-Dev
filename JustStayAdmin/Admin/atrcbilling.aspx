<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Site1.Master" CodeBehind="atrcbilling.aspx.cs" Inherits="JustStayAdmin.Admin.atrcbilling" %>
    ...
    <div class="sb2-2">
        <div class="sb2-2-2">
            <ul>
                ...
                <li class="active-bre"><a href="registrationreport.aspx">ATRC Billing</a>
                </li>
            </ul>
        </div>
        <div class="sb2-2-3">
            <div class="row">
                ...
                <div class="box-inn-sp">
                    ...
                    <div class="input-field col s2">
                        <asp:Button ID="btnatrcbillreport" runat="server" Text="Generate ATRC Bill / Invoice" CssClass="btn btn-info" OnClick="btnatrcbillreport_Click" OnClientClick="gethtml();" />
        ...
        <div class="row">
            <ul class="nav navbar-right panel_toolbox">
                <li><asp:LinkButton ID="lnkpay" runat="server" Text="Pay Amount to ATRC" OnClick="lnkpay_Click"></asp:LinkButton></li>
                <li><asp:LinkButton ID="lnksendtoclient" runat="server" Text="Send Invoice to Client" OnClick="lnksendtoclient_Click"></asp:LinkButton></li>
                <li class="dropdown">
