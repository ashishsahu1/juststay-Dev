<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ViewMail.aspx.cs" Inherits="JustStay.ATRC.ViewMail" %>
                ...
                <div class="col-md-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="hpanel email-compose mailbox-view">
                        ...
                        <div class="panel-body panel-csm">
                            ...
                            <asp:GridView ID="grdattachments" runat="server" Border="0" AutoGenerateColumns="false" CssClass="table table-hover" OnRowCommand="grdattachments_RowCommand" 
                                Width="100%" DataKeyNames="AttachmentId">
                                <Columns>
